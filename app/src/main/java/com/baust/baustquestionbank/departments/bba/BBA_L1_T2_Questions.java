...
public class BBA_L1_T2_Questions extends AppCompatActivity implements View.OnClickListener, Sheet.ReadMethod{
 ...
 @Override
    ...
    public void offlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.BBA1201id) {

                String pdfName = matchYear + "bba_BBA1201";
            ...
            if (globalView.getId() == R.id.BBA1202id) {
                String pdfName = matchYear + "bba_BBA1202";
            ...
            if (globalView.getId() == R.id.BBA1203id) {
                String pdfName = matchYear + "bba_BBA1203";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.BBA1204id) {
                String pdfName = matchYear + "bba_BBA1204";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.BBA1205id) {
                String pdfName = matchYear + "bba_BBA1205";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
    ...
    public void onlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.BBA1201id) {
                ...
                Intent intent = new Intent(BBA_L1_T2_Questions.this, OnlinePdfView.class);
