...
import com.baust.baustquestionbank.departments.cse.L1_T2_Questions;



public class EEE_L1_T2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e_e_e__l1__t2);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (x.equals("Fall -2017")) {
                    Intent intent=new Intent(EEE_L1_T2.this, EEE_L1_T2_Questions.class);
