...
public class BBA_L4_T1_Questions extends AppCompatActivity implements View.OnClickListener, Sheet.ReadMethod{
    ...
    public void offlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.BBA4101id) {

                String pdfName = matchYear + "bba_BBA4101";
            ...
            if (globalView.getId() == R.id.BBA4102id) {
                String pdfName = matchYear + "bba_BBA4102";
            ...
            if (globalView.getId() == R.id.BBA4103id) {
                String pdfName = matchYear + "bba_BBA4103";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.BBA4104id) {
                String pdfName = matchYear + "bba_BBA4104";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.BBA4105id) {
    ...
    public void onlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.BBA4101id) {
                ...
                Intent intent = new Intent(BBA_L4_T1_Questions.this, OnlinePdfView.class);
