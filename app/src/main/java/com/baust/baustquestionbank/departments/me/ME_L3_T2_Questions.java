...
public class ME_L3_T2_Questions extends AppCompatActivity implements View.OnClickListener, Sheet.ReadMethod{
    ...
    public void offlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.ME3201id) {

                String pdfName = matchYear + "me_ME3201";
            ...
            if (globalView.getId() == R.id.ME3203id) {
                String pdfName = matchYear + "me_ME3203";
            ...
            if (globalView.getId() == R.id.ME3205id) {
                String pdfName = matchYear + "me_ME3205";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.ME3213id) {
                String pdfName = matchYear + "me_ME3213";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.IPE3277id) {
                String pdfName = matchYear + "me_IPE3277";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
    ...
    public void onlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.ME3201id) {
                ...
                Intent intent = new Intent(ME_L3_T2_Questions.this, OnlinePdfView.class);
