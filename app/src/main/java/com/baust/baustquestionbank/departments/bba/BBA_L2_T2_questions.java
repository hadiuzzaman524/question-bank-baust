...
public class BBA_L2_T2_questions extends AppCompatActivity implements View.OnClickListener, Sheet.ReadMethod{
...
@Override
    ...
    public void offlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.BBA2201id) {

                String pdfName = matchYear + "bba_BBA2201";
            ...
            if (globalView.getId() == R.id.BBA2202id) {
                String pdfName = matchYear + "bba_BBA2202";
            ...
            if (globalView.getId() == R.id.BBA2203id) {
                String pdfName = matchYear + "bba_BBA2203";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.BBA2204id) {
                String pdfName = matchYear + "bba_BBA2204";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.BBA2205id) {
                String pdfName = matchYear + "bba_BBA2205";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
    ...
    public void onlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.BBA2201id) {
                ...
                Intent intent = new Intent(BBA_L2_T2_questions.this, OnlinePdfView.class);
