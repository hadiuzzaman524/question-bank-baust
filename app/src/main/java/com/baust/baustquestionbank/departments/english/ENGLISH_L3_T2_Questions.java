...
public class ENGLISH_L3_T2_Questions extends AppCompatActivity implements View.OnClickListener {
    ...
    private void downloadFall17(View view) {
        ...
        if (view.getId() == R.id.ENG3201id) {
            ...
            String pdfName = "F17english_ENG3201";
        ...
        if (view.getId() == R.id.ENG3201download) {
        ...
        if (view.getId() == R.id.ENG3202id) {
            ...
            String pdfName = "F17english_ENG3202";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3202download) {
        ...
        if (view.getId() == R.id.ENG3203id) {
            String pdfName = "F17english_ENG3203";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3203download) {
        ...
        if (view.getId() == R.id.ENG3204id) {
            String pdfName = "F17english_ENG3204";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3204download) {
        ...
        if (view.getId() == R.id.ENG3205id) {
            String pdfName = "F17english_ENG3205";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3205download) {
            String link = "";
            String pdfName = "F17english_ENG3205";
            if (file.notDownload(pdfName)) {
                download(link, pdfName);
    ...
    private void downloadSpring17(View view) {
        ...
        if (view.getId() == R.id.ENG3201id) {
            ...
            String pdfName = "S17english_ENG3201";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3202id) {
            ...
            String pdfName = "S17english_ENG3202";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3203id) {
            String pdfName = "S17english_ENG3203";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3204id) {
            String pdfName = "S17english_ENG3204";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3205id) {
            String pdfName = "S17english_ENG3205";
            if (file.isDownload(pdfName)) {
    ...
    private void downloadFall18(View view) {
        ...
        if (view.getId() == R.id.ENG3201id) {
            ...
            String pdfName = "F18english_ENG3201";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3202id) {
            ...
            String pdfName = "F18english_ENG3202";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3203id) {
            String pdfName = "F18english_ENG3203";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3204id) {
            String pdfName = "F18english_ENG3204";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3205id) {
            String pdfName = "F18english_ENG3205";
            if (file.isDownload(pdfName)) {
    ...
    private void downloadSpring18(View view) {
        ...
        if (view.getId() == R.id.ENG3201id) {
            ...
            String pdfName = "S18english_ENG3201";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3202id) {
            ...
            String pdfName = "S18english_ENG3202";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3203id) {
            String pdfName = "S18english_ENG3203";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3204id) {
            String pdfName = "S18english_ENG3204";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3205id) {
            String pdfName = "S18english_ENG3205";
            if (file.isDownload(pdfName)) {
    ...
    private void downloadFall19(View view) {
        ...
        if (view.getId() == R.id.ENG3201id) {
            ...
            String pdfName = "F19english_ENG3201";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3202id) {
            ...
            String pdfName = "F19english_ENG3202";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3203id) {
            String pdfName = "F19english_ENG3203";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3204id) {
            String pdfName = "F19english_ENG3204";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3205id) {
            String pdfName = "F19english_ENG3205";
            if (file.isDownload(pdfName)) {
    ...
    private void downloadSpring19(View view) {
        ...
        if (view.getId() == R.id.ENG3201id) {
            ...
            String pdfName = "S19english_ENG3201";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3202id) {
            ...
            String pdfName = "S19english_ENG3202";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3203id) {
            String pdfName = "S19english_ENG3203";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3204id) {
            String pdfName = "S19english_ENG3204";
            if (file.isDownload(pdfName)) {
        ...
        if (view.getId() == R.id.ENG3205id) {
            String pdfName = "S19english_ENG3205";
            if (file.isDownload(pdfName)) {
