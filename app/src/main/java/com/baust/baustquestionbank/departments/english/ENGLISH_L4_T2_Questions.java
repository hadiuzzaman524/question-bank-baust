...
public class ENGLISH_L4_T2_Questions extends AppCompatActivity implements View.OnClickListener, Sheet.ReadMethod{
    ...
    private void downloadQuestions(View view,String Y){
        ...
        {
            String pdfName = Y+"english_ENG4201";
        ...
        {
            String pdfName = Y+"english_ENG4202";
            if (file.isDownload(pdfName)) {
        ...
        {
            String pdfName = Y+"english_ENG4203";
            if (file.isDownload(pdfName)) {
        ...
        {
            String pdfName = Y+"english_ENG4204";
            if (file.isDownload(pdfName)) {
        ...
        {
            String pdfName = Y+"english_ENG4205";
            if (file.isDownload(pdfName)) {
        ...
        {
            String pdfName = Y+"english_ENG4206";
            if (file.isDownload(pdfName)) {
        ...
        {
            String pdfName = Y+"english_ENG4207";
            if (file.isDownload(pdfName)) {
    ...
    public void offlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.ENG4201id) {

                String pdfName = matchYear + "english_ENG4201";
            ...
            if (globalView.getId() == R.id.ENG4202id) {
                String pdfName = matchYear + "english_ENG4202";
            ...
            if (globalView.getId() == R.id.ENG4203id) {
                String pdfName = matchYear + "english_ENG4203";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.ENG4204id) {
                String pdfName = matchYear + "english_ENG4204";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.ENG4205id) {
                String pdfName = matchYear + "english_ENG4205";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.ENG4206id) {
                String pdfName = matchYear + "english_ENG4206";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.ENG4207id) {
                String pdfName = matchYear + "english_ENG4207";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
    ...
    public void onlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.ENG4201id) {
                ...
                Intent intent = new Intent(ENGLISH_L4_T2_Questions.this, OnlinePdfView.class);
