...
import com.baust.baustquestionbank.departments.eee.EEE_L1_T2;
import com.baust.baustquestionbank.departments.eee.EEE_L2_T1;
import com.baust.baustquestionbank.departments.eee.EEE_L2_T2;
import com.baust.baustquestionbank.departments.eee.EEE_L3_T1;
import com.baust.baustquestionbank.departments.eee.EEE_L3_T2;
import com.baust.baustquestionbank.departments.eee.EEE_L4_T1;
import com.baust.baustquestionbank.departments.eee.EEE_L4_T2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0) {
                    Intent intent = new Intent(EEE.this, EEE_L1_T1.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);

                }
                if (i == 1) {
                    Intent intent = new Intent(EEE.this, EEE_L1_T2.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }
                if (i == 2) {
                    Intent intent = new Intent(EEE.this, EEE_L2_T1.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }
                if (i == 3) {
                    Intent intent = new Intent(EEE.this, EEE_L2_T2.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }
                if (i == 4) {
                    Intent intent = new Intent(EEE.this, EEE_L3_T1.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }
                if (i == 5) {
                    Intent intent = new Intent(EEE.this, EEE_L3_T2.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }
                if (i == 6) {
                    Intent intent = new Intent(EEE.this, EEE_L4_T1.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }
                if (i == 7) {
                    Intent intent = new Intent(EEE.this, EEE_L4_T2.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                }
            }
