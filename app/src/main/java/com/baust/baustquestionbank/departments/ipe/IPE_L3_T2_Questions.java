...
public class IPE_L3_T2_Questions extends AppCompatActivity implements View.OnClickListener, Sheet.ReadMethod{
    ...
    public void offlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.IPE3201id) {

                String pdfName = matchYear + "ipe_IPE3201";
            ...
            if (globalView.getId() == R.id.IPE3203id) {
                String pdfName = matchYear + "ipe_IPE3203";
            ...
            if (globalView.getId() == R.id.IPE3205id) {
                String pdfName = matchYear + "ipe_IPE3205";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.IPE3207id) {
                String pdfName = matchYear + "ipe_IPE3207";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.IPE3209id) {
                String pdfName = matchYear + "ipe_IPE3209";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
    ...
    public void onlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.IPE3201id) {
                ...
                Intent intent = new Intent(IPE_L3_T2_Questions.this, OnlinePdfView.class);
