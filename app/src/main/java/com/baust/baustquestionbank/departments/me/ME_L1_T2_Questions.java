...
public class ME_L1_T2_Questions extends AppCompatActivity implements View.OnClickListener, Sheet.ReadMethod {
    ...
    public void offlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.CHEM1203id) {

                String pdfName = matchYear + "me_CHEM1203";
            ...
            if (globalView.getId() == R.id.CSE1271id) {
                String pdfName = matchYear + "me_CSE1271";
            ...
            if (globalView.getId() == R.id.HUM1215id) {
                String pdfName = matchYear + "me_HUM1215";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.MATH1201id) {
                String pdfName = matchYear + "me_MATH1201";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.PHY1205id) {
                String pdfName = matchYear + "me_PHY1205";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
    ...
    public void onlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.CHEM1203id) {
                ...
                Intent intent = new Intent(ME_L1_T2_Questions.this, OnlinePdfView.class);
