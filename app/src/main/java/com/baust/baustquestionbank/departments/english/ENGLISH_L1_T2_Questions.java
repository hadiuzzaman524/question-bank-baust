...
public class ENGLISH_L1_T2_Questions extends AppCompatActivity implements View.OnClickListener , Sheet.ReadMethod{
    ...
    private void downloadQuestions(View view,String Y){
        ...
        {
            String pdfName = Y+"english_ENG1201";
        ...
        {
            String pdfName = Y+"english_ENG1202";
            if (file.isDownload(pdfName)) {
        ...
        {
            String pdfName = Y+"english_ENG1203";
            if (file.isDownload(pdfName)) {
        ...
        {
            String pdfName = Y+"english_ENG1204";
            if (file.isDownload(pdfName)) {
        ...
        {
            String pdfName = Y+"english_ENG1205";
            if (file.isDownload(pdfName)) {
    ...
    public void offlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.ENG1201id) {

                String pdfName = matchYear + "english_ENG1201";
            ...
            if (globalView.getId() == R.id.ENG1202id) {
                String pdfName = matchYear + "english_ENG1202";
            ...
            if (globalView.getId() == R.id.ENG1203id) {
                String pdfName = matchYear + "english_ENG1203";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.ENG1204id) {
                String pdfName = matchYear + "english_ENG1204";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
            ...
            if (globalView.getId() == R.id.ENG1205id) {
                String pdfName = matchYear + "english_ENG1205";
                String link = "https://www.webpages.uidaho.edu/~stevel/301answer/6.pdf";
                if (file.notDownload(pdfName)) {
                    download(link, pdfName);
                    Toast.makeText(getApplicationContext(), "Download Start", Toast.LENGTH_SHORT).show();
    ...
    public void onlineRead(boolean flag) {
        if (examyear.equals("Fall -2017")) {
            ...
            if (globalView.getId() == R.id.ENG1201id) {
                ...
                Intent intent = new Intent(ENGLISH_L1_T2_Questions.this, OnlinePdfView.class);
